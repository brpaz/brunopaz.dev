...
permalink: how-do-i-organize-my-knowledge-as-a-software-engineer
...
import notionPageStructureImg from '../../assets/images/blog/kRnuvMV.png'
...
<Picture src={notionPageStructureImg} alt="Notion page structure" />
