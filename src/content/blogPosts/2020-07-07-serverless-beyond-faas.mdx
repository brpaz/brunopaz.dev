...
permalink: serverless-beyond-faas
...
import img1 from '../../assets/images/blog/srlu3tkztl4dwuoi3hi9.jpg';
import img2 from '../../assets/images/blog/w8smkpat272msl3p95i1.jpg'
...
<Picture src={img1} alt="Serverless Architecture evolution" />

So now, instead of having 50 Microservices, you have 1000 functions! ;)

<Picture src={img2} alt="Meme: Deploy all the functions!" />
