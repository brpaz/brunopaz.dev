...
permalink: how-to-keep-software-installed-from-github-updated-with-ansible
...
Ansible includes many built-in modules, like "copy" or "command", that abstracts common actions like copy files or execute shell commands. You can check all the available [builtin-modules](https://docs.ansible.com/ansible/latest/collections/ansible/builtin/index.html).
