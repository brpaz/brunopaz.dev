...
permalink: how-to-create-your-own-auto-completion-for-json-and-yaml-files-on-vs-code-with-the-help-of-json-schema
...
import img1 from '../../assets/images/blog/adf822b5-e2f0-446b-9c65-006f2d72496a.gif'
import img2 from '../../assets/images/blog/d7b1eca5-800b-4c4f-8da5-9bf0027625d6.png'
import img3 from '../../assets/images/blog/8dfddd2d-67c9-4b29-b05a-d534282bd6d4.gif'
...
<Picture src={img1} alt="Completion example"/>
...
<Picture src={img2} alt="Settings Page" />
...
<Picture src={img3} alt="Hadolint Autocomplete" />
