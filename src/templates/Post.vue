<template>
  <Layout>
    <div class="container-inner mx-auto my-16">
      ...
      <div
        v-if="$page.post.devto_url"
        class="mb-8 bg-gray-300 border-t border-b border-gray-500 text-gray-500 px-4 py-3"
      >
        <p class="font-bold">
          This post was cross posted on
          <a :href="$page.post.devto_url">dev.to</a>
        </p>
      </div>
  ...
  metaInfo() {
    ...
    return {
      ...
      meta: [
        ...
        { name: 'monetization', content: meta.monetization_pointer_url },
      ...
      script: [
        {
          src:
            'https://s7.addthis.com/js/300/addthis_widget.js#pubid=' +
            process.env.GRIDSOME_ADDTHIS_ID,
          body: true
        }
      ]
    };
