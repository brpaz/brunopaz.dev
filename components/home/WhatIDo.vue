  ...
  <div class="flex flex-col mx-auto">
    ...
    <div class="flex justify-between flex-wrap">
      ...
      >
        ...
        <h3 class="text-lg font-semibold mb-4">Web Development</h3>

        <p>
          Web is my passion and I develop entire solutions, from idea to
          production, always looking to use the most appropriate Technology for
          the project.
        </p>
      </div>
      ...
      >
        ...
        <h3 class="text-lg font-semibold mb-4">Quality first</h3>

        <p>
          I have a strong focus on Code Quality and Engineering best practices
          like TDD, CI / CD and Automation.
        </p>
      </div>
      ...
      >
        ...
        <h3 class="text-lg font-semibold mb-4">Blogging</h3>
