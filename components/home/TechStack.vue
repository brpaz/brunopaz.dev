<template>
  ...
  >
    ...
    <div class="mb-12">
      <p>
        These are some technologies and tools that I am familiar with and that I
        used over the years, both in professional and personal projects.
      </p>
    </div>
...
#tech-stack .language-logo {
  width: 120px;
  height: 120px;
  @apply flex items-center mr-8 mb-8;
