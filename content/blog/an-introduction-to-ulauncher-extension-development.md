...
tags: ['development','ulauncher','linux']
devto_url: https://dev.to/brpaz/an-introduction-to-ulauncher-extension-development-1m69/edit
---
...
Add this to the end of the file, before "if __name__ == '__main__'" line:
